...
export default function AhaResponsiveFix() {
  return (
    <style jsx global>{`
      ...
      /* Login secondary links: plain text, not buttons. */
      .aha-auth-row {
      ...
      .aha-auth-row .aha-auth-link:last-child { color: #000 !important; order: 0 !important; cursor: default !important; pointer-events: none !important; }
      .aha-auth-row .aha-auth-link:last-child strong { color: #000 !important; font-weight: 500 !important; }
      ...
      /* ---------- HOME ---------- */
      /* Compact the whole hero card; the photo still fills the card height. */
      .aha-v3-hero,
      .aha-v3-hero-card,
      .aha-v3-hero-banner {
      ...
      /* Profile is the ONLY top-right action on Home. Notification remains in
         the bottom navigation, so there is no duplicated bell in the header. */
      .aha-v3-top-actions {
        display: flex !important;
        align-items: center !important;
        justify-content: flex-end !important;
      ...
      .aha-v3-top-actions > button:nth-child(1),
      .aha-v3-top-actions > button:nth-child(3) {
        display: none !important;
      }
      .aha-v3-top-actions > button:nth-child(2) {
      ...
      .aha-v3-top-actions > button:nth-child(2) .aha-v3-user-avatar {
        display: grid !important;
        place-items: center !important;
      ...
      @media (max-width: 390px) {
        .aha-auth-row { justify-content: space-between !important; gap: 10px !important; }
