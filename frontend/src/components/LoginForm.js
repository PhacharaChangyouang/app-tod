      ...
      <section className="aha-auth-form-panel">
        ...
        <form onSubmit={submit}>
          ...
          {mode==='register'&&<>
            ...
            <div className="aha-auth-field-row"><div className="aha-auth-field"><label>รหัสผ่าน</label><input type="password" value={register.password} onChange={e=>updateRegister('password',e.target.value)} placeholder="อย่างน้อย 8 ตัว" required/></div><div className="aha-auth-field"><label>ยืนยันรหัสผ่าน</label><input type="password" value={register.confirmPassword} onChange={e=>updateRegister('confirmPassword',e.target.value)} required/></div></div>
