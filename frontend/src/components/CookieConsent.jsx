...
export default function CookieConsent() {
  ...
  return (
    <aside className="aha-cookie-banner" role="dialog" aria-live="polite" aria-label="การใช้คุกกี้">
      ...
      <style jsx>{`
        .aha-cookie-banner{position:fixed;z-index:10000;left:50%;bottom:max(18px,env(safe-area-inset-bottom,0px));transform:translateX(-50%);width:min(920px,calc(100% - 28px));display:flex;align-items:center;gap:18px;padding:18px 54px 18px 20px;border:1px solid #cfe1e5;border-radius:18px;background:#fff;color:#20343c;box-shadow:0 18px 55px rgba(18,55,70,.2);font-family:Arial,"Noto Sans Thai",sans-serif}.aha-cookie-copy{flex:1;min-width:0}.aha-cookie-copy strong{display:block;font-size:15px;margin-bottom:4px}.aha-cookie-copy p{margin:0;color:#5e747c;font-size:13px;line-height:1.65}.aha-cookie-copy :global(a){color:#167fa6;font-weight:800;text-decoration:underline;text-underline-offset:2px}.aha-cookie-accept{flex:0 0 auto;min-width:104px;min-height:44px;border:0;border-radius:12px;background:#ffb84d;color:#111;font-weight:900;cursor:pointer}.aha-cookie-close{position:absolute;right:12px;top:10px;width:34px;height:34px;border:0;border-radius:50%;background:#eef4f5;color:#536c75;font-size:25px;line-height:1;cursor:pointer}.aha-cookie-accept:focus-visible,.aha-cookie-close:focus-visible,.aha-cookie-copy :global(a:focus-visible){outline:3px solid rgba(255,184,77,.4);outline-offset:2px}
