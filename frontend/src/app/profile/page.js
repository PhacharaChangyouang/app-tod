    ...
    <div className="aha-profile-page">
      ...
      <main className="aha-profile-wrap">
        ...
        <section className="aha-profile-section aha-profile-legal">
          ...
          <p className="aha-profile-copyright">© 2026 ahahealth.online - สงวนลิขสิทธิ์</p>
        </section>
      ...
      <style jsx>{`
        ...
        .aha-profile-legal-links{display:grid;border:1px solid var(--aha-border,#e2e3e6);border-radius:15px;overflow:hidden}.aha-profile-legal-links :global(a){min-height:52px;padding:0 15px;display:flex;align-items:center;justify-content:space-between;gap:12px;color:var(--aha-text,#111);background:var(--aha-surface-soft,#f1f2f4);font-weight:800;text-decoration:none;border-bottom:1px solid var(--aha-border,#e2e3e6)}.aha-profile-legal-links :global(a:last-child){border-bottom:0}.aha-profile-legal-links :global(a:hover){color:#2f6bff}.aha-profile-legal-links :global(span){font-size:24px;color:#2f6bff}.aha-profile-copyright{margin:15px 0 0;text-align:center;color:var(--aha-text-secondary,#62666d);font-size:12px}
