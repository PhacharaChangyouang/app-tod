                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: const InputDecoration(
                            prefixIcon: Icon(Icons.phone_rounded, color: AppTheme.primaryBlue),
                            hintText: '0812345678',
                          ),
                        ),
                        if (_error != null) ...[
                          const SizedBox(height: 10),
                          Text(_error!, style: const TextStyle(color: AppTheme.sosRed, fontSize: 16)),
                        ],
                        const SizedBox(height: 24),
                        ElevatedButton(
